# Relationship Convergence Checklist

> The relational analog of STEP 5 in the single-chart skill. Run this before
> writing the relational synthesis. As in the single-chart reading, convergence
> is the engine: when multiple independent signals point at the same relational
> theme, that agreement — stated once, jargon-free — is the Blueprint line. It
> sets the *confidence* and *ordering* of relational claims, never their phrasing.
>
> Slice scope: Western only (inter-aspects + composite). The later rows are
> listed so the checklist is ready for the seven-system version, but they are
> not computed in the slice.
...
No score. No percentage. No "should you." Convergence raises confidence in a
*description of the weather*, never in a verdict about whether the relationship
is good or viable.
